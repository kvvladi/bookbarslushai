...
# Ключ — наша категория из меню, значение — максимально широкие ключевые
# слова для поиска по каталогу ЛитРес. Широкие теги обеспечивают большой
# пул кандидатов на Уровне 2 (глубокий поиск), когда топ-20 уже прочитаны.
MOOD_TO_LITRES = {
    "Уютный вечер": (
        "современная проза уютное бестселлеры семейная сага "
        "маленькая жизнь дерево растет в Бруклине алхимик "
        "полуночная библиотека служба доставки книг"
    ),
    "Хочу острых ощущений": (
        "остросюжетный триллер боевик бестселлеры детектив "
        "психологический триллер тайная история американская грязь "
        "десять негритят безмолвный пациент граф монте-кристо "
        "молчание ягнят сияние парфюмер ребекка снеговик "
        "остров проклятых милые кости головокружение зодиак"
    ),
    "Немного поплакать": (
        "драма современная проза трагедия сентиментальная проза "
        "маленькая жизнь щегол книжный вор до встречи с тобой "
        "мальчик в полосатой пижаме ханья янагихара достоевский "
        "толстой анна каренина любовь во время холеры поющие в терновнике"
    ),
    ...
    "Пища для ума": (
        "научно-популярная литература хиты зарубежная классика "
        "русская классика мировые бестселлеры философия психология "
        "история науки sapiens биология добра и зла думай медленно "
        "решай быстро портрет дориана грея 1984 о дивный новый мир "
        "преступление и наказание игра в бисер искусство любить фауст "
        "краткая история времени эгоистичный ген черный лебедь"
    ),
    "Лёгкость и смех": (
        "английский юмор комедия ироническая проза сатира смешная книга "
        "дживс и вустер безумно богатые азиаты трое в лодке не считая собаки "
        "автостопом по галактике дон кихот благие знамения двенадцать стульев "
        "золотой теленок понедельник начинается в субботу дневник бриджит джонс "
        "моя семья и другие звери манюня кентервильское привидение "
        "сто лет и чемодан денег в придачу пиквикский клуб"
    ),
    "Уйти от реальности": (
        "магический реализм эпическая фантастика научная фантастика "
        "фэнтези космос магия мастер и маргарита дюна властелин колец "
        "американские боги дом в котором алиса в стране чудес "
        "хроники нарнии игра престолов"
    ),
    "Закрытый клуб": (
        "интеллектуальный детектив классика популярное зарубежная классика "
        "русская классика мировые бестселлеры академия искусств тайна "
        "словно мы злодеи тень ветра тринадцатая сказка голландский дом "
        "маятник фуко авессалом авессалом франкенштейн клуб дюма "
        "волхв пикник у висячей скалы облачный атлас игра в бисер "
        "имя розы степной волк"
    ),
    "Проглотить за одну ночь": (
        "остросюжетный детектив триллер бестселлеры детектив "
        "семь смертей эвелины хардкасл правда о деле гарри квеберта "
        "исчезнувшая код да винчи собака баскервилей безмолвный пациент "
        "девушка с татуировкой дракона убийство в восточном экспрессе "
        "молчание ягнят ребекка остров проклятых мизери девушка в поезде "
        "ангелы и демоны"
    ),
    "Моральный детокс": (
        "современная проза вдохновляющие бестселлеры добрая история "
        "вторая жизнь уве полуночная библиотека служба доставки книг "
        "маленький принц таинственный сад тревожные люди просто вместе "
        "элеанор олифант в полном порядке поллианна чайка по имени джонатан ливингстон "
        "мой дедушка был вишней дерево растет в бруклине алхимик дары волхвов "
        "жизнь пи"
    ),
    # Новые категории меню: детективы/триллеры, любовные романы, фэнтези.
    "Холодный расчёт": (
        "интеллектуальный детектив триллер расследование загадка "
        "шерлок холмс агата кристи детектив классика "
        "десять негритят девушка с татуировкой дракона молчание ягнят "
        "снеговик происхождение дэн браун"
    ),
    "Пьянящая романтика": (
        "современный любовный роман зарубежная сентиментальная проза "
        "бестселлеры хиты романтика любовь унесённые ветром грозовой перевал "
        "анна каренина любовь во время холеры поющие в терновнике "
        "убить во имя любви вернись ко мне до встречи со мной "
        "последнее письмо от твоего любимого дневник памяти счастливчик "
        "николас спаркс джоджо мойес"
    ),
    "Шагнуть в портал": (
        "эпическое фэнтези магия миры хиты продаж фэнтези "
        "научная фантастика космос волшебство властелин колец "
        "гарри поттер философский камень хроники нарнии лев колдунья "
        "платяной шкаф игра престолов алиса в стране чудес "
        "дюна американские боги"
    ),
}
...
# Глубина поиска для Уровня 2 (когда топ-20 уже прочитаны).
LITRES_DEEP_N = 50
...
def get_litres_books_deep(category: str) -> tuple:
    """Возвращает расширенный список (топ-LITRES_DEEP_N) кандидатов по категории.

    Используется на Уровне 2 каскадного поиска, когда топ-20 популярных
    книг уже прочитаны пользователем. Запрашивает больше результатов
    из ЛитРес (limit=100), чтобы увеличить шансы найти непрочитанные
    книги в глубине каталога.

    НЕ кэшируется (нет @lru_cache), чтобы каждый запрос получал свежие
    данные от API. При таймауте/ошибке возвращает пустой кортеж.
    """
    query = MOOD_TO_LITRES.get(category)
    if not query:
        return tuple()
    ...
    params = {
        "q": query,
        "types": "text_book",
        "limit": 100,           # запрашиваем больше результатов для глубокого поиска
    ...
    try:
        ...
        logger.warning("ЛитРес не ответил за 2.5с (timeout) для глубокого поиска %r", category)
        return tuple()
    except (requests.RequestException, ValueError):
        logger.warning("Ошибка запроса к ЛитРес для глубокого поиска %r", category)
        return tuple()
    ...
    # Жёсткий фильтр качества: рейтинг >= 3.5
    def _has_valid_rating(item: dict) -> bool:
        inst = item.get("instance") or {}
        rating_obj = inst.get("rating") or {}
        rating = rating_obj.get("rated_avg")
    ...
    # Берём топ-LITRES_DEEP_N самых популярных книг
    candidates = []
    for item in items[:LITRES_DEEP_N]:
        inst = item.get("instance") or {}
        if not inst.get("cover_url"):
            continue
...
def send_recommendation(chat_id: int, category: str, exclude_hash: str | None = None) -> None:
    ...
    Каскадный алгоритм из 3 уровней:
    1. Топ-20 популярных книг из ЛитРес (уровень 1).
    2. Глубокий поиск (топ-50) из ЛитРес, если топ-20 уже прочитаны (уровень 2).
    3. Внутренняя библиотека books.json, если API иссякло (уровень 3).
    4. Заглушка, если всё прочитано (уровень 4).

    Бот переходит к следующему уровню ТОЛЬКО если после фильтрации
    прочитанного список оказался пустым.
    ...
    """
    # Вспомогательная функция: фильтрует список книг по exclude_hash и прочитанным.
    def _filter_unread(books: list[dict]) -> list[dict]:
        result = books
        # Исключаем текущую книгу (защита от дублей в «Следующая книга»).
        if exclude_hash:
            result = [b for b in result if _book_hash(b) != exclude_hash]
        # Исключаем книги, которые пользователь уже сохранил/прочитал.
        if chat_id is not None and result:
            user_titles = get_user_book_titles(chat_id, ["saved", "read"])
            if user_titles:
                result = [b for b in result if b.get("Название") not in user_titles]
        return result

    # УРОВЕНЬ 1: Самые популярные (Топ-20) из ЛитРес.
    api_books_level1 = list(get_litres_books_list(category))
    unread_books = _filter_unread(api_books_level1)

    # УРОВЕНЬ 2: Глубокий поиск (Топ-50), если топ-20 уже прочитаны.
    if not unread_books:
        api_books_level2 = list(get_litres_books_deep(category))
        unread_books = _filter_unread(api_books_level2)

    # УРОВЕНЬ 3: Фоллбэк на внутреннюю библиотеку (если API иссякло).
    if not unread_books:
        books_db = _load_curated()
        ...
        unread_books = _filter_unread(json_books)

    # УРОВЕНЬ 4: Заглушка (если прочитано вообще всё).
    if not unread_books:
        _tg_call(bot.send_message,
            chat_id,
    ...
    # Выдача случайной книги из того списка, который сработал.
